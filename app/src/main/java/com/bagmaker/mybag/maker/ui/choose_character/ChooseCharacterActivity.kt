...
import com.bagmaker.mybag.maker.databinding.ActivityChooseCharacterBinding
...
class ChooseCharacterActivity : BaseActivity<ActivityChooseCharacterBinding>() {
    ...
    private fun checkInternetForAPICharacters(data: ArrayList<com.bagmaker.mybag.maker.data.model.custom.CustomizeModel>) {
    ...
    override fun initActionBar() {
        binding.actionBar.apply {
            ...
            setTextActionBar(tvCenter, getString(R.string.bag_maker))
            tvCenter.select()
        }
    }
