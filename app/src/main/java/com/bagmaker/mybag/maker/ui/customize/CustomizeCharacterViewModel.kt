...
import com.bagmaker.mybag.maker.core.helper.InternetHelper
import com.bagmaker.mybag.maker.core.helper.MediaHelper
import com.bagmaker.mybag.maker.core.utils.key.AssetsKey
...
import com.bagmaker.mybag.maker.data.model.custom.ItemColorImageModel
...
import com.bagmaker.mybag.maker.data.model.custom.LayerListModel
import com.bagmaker.mybag.maker.data.model.custom.LayerTransformModel
import com.bagmaker.mybag.maker.data.model.custom.NavigationModel
    ...
    fun checkDataInternet(context: CustomizeCharacterActivity, action: (() -> Unit)) {
        ...
        InternetHelper.checkInternet(context) { result ->
            if (result == HandleState.SUCCESS) {
                ...
                val dialog = com.bagmaker.mybag.maker.dialog.YesNoDialog(
                    context,
                    R.string.no_internet,
                    R.string.please_check_your_internet,
                    isError = true,
                    dialogType = com.bagmaker.mybag.maker.dialog.DialogType.INTERNET
                )
                dialog.show()
                dialog.onYesClick = {
                    dialog.dismiss()
