...
import com.bagmaker.mybag.maker.databinding.ActivityIntroBinding
import com.bagmaker.mybag.maker.ui.home.HomeActivity
import com.bagmaker.mybag.maker.ui.permission.PermissionActivity
        ...
        binding.vpgTutorial.registerOnPageChangeCallback(object :
            ...
            override fun onPageSelected(position: Int) {
                ...
                if (position == 0) {
                    ...
                    binding.btnNext.layoutParams = params
                    binding.btnNext.setTextColor(Color.parseColor("#FFCC00"))
