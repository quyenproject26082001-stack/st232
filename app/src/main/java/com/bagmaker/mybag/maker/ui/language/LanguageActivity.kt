package com.bagmaker.mybag.maker.ui.language
...
import com.bagmaker.mybag.maker.databinding.ActivityLanguageBinding
import com.bagmaker.mybag.maker.ui.home.HomeActivity
import com.bagmaker.mybag.maker.ui.intro.IntroActivity
...
class LanguageActivity : BaseActivity<ActivityLanguageBinding>() {
    ...
    override fun initView() {
        ...
        if (!viewModel.isFirstLanguage.value) {
            binding.btnBackground.setBackgroundResource(R.drawable.bg_app1)
    ...
    override fun initActionBar() {
        binding.actionBar.apply {
            ...
            btnActionBarRightLang.setImageResource(
                if(viewModel.isFirstLanguage.value) R.drawable.ic_done
                else R.drawable.ic_done_setting
            )
