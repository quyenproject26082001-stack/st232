...
import com.bagmaker.mybag.maker.data.model.LanguageModel
import com.bagmaker.mybag.maker.databinding.ItemLanguageBinding
    ...
    override fun onBind(
        ...
        binding.apply {
            ...
            val textColor = if (item.activate) {
                ...
                android.graphics.Color.parseColor("#018DBD") // Dark blue when not selected
            }
