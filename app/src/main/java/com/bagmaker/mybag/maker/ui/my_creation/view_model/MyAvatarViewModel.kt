package com.bagmaker.mybag.maker.ui.my_creation.view_model
...
import com.bagmaker.mybag.maker.data.model.MyAlbumModel
        ...
        InternetHelper.checkInternet(context) { result ->
            if (result == HandleState.SUCCESS) {
                ...
                val dialog = com.bagmaker.mybag.maker.dialog.YesNoDialog(
                    context,
                    com.bagmaker.mybag.maker.R.string.no_internet,
                    com.bagmaker.mybag.maker.R.string.please_check_your_internet,
                    isError = true,
