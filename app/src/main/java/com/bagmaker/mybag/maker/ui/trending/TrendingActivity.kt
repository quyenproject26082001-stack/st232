package com.bagmaker.mybag.maker.ui.trending
...
import com.bagmaker.mybag.maker.databinding.ActivityTrendingBinding
...
class TrendingActivity : BaseActivity<ActivityTrendingBinding>() {
    ...
    private fun initData() {
        ...
        CoroutineScope(SupervisorJob() + Dispatchers.Main + handleExceptionCoroutine).launch {
            ...
            suspend fun processCharacter(data: com.bagmaker.mybag.maker.data.model.custom.CustomizeModel) {
