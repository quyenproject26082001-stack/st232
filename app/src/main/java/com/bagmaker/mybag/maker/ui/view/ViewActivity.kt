package com.bagmaker.mybag.maker.ui.view
...
import com.bagmaker.mybag.maker.core.extensions.loadImageFromFile
...
import com.bagmaker.mybag.maker.databinding.ActivityViewBinding
import com.bagmaker.mybag.maker.dialog.YesNoDialog
import com.bagmaker.mybag.maker.ui.customize.CustomizeCharacterActivity
...
class ViewActivity : BaseActivity<ActivityViewBinding>() {
    ...
    private fun resetMyCreationSelectionMode() {
        ...
        if (myCreationActivity != null) {
            ...
            if (designFragment is com.bagmaker.mybag.maker.ui.my_creation.fragment.MyDesignFragment) {
